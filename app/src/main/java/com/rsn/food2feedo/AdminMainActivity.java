...
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle=new ActionBarDrawerToggle(AdminMainActivity.this,dr,tb,R.string.OpenDrawer,R.string.CloseDrawer);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    ...
                    case R.id.share:
                        ...
                        break;
                    default:
                        Toast.makeText(AdminMainActivity.this, "Nothing selected", Toast.LENGTH_SHORT).show();
                        break;
